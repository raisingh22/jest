...
const Login = () => {
  ...
  const handleJokeUpdate = async (jokeId,language,token) => {
    setLoading(true);
    try {
      const token = localStorage.getItem("accessToken");
      // Pass the updatedJokeText to the updateJoke API call
      await updateJoke(token, jokeId, updatedJokeText);
                      ...
                      <>
                        ...
                        <div className="col-auto">
                          <svg
                            ...
                            viewBox="0 0 16 16"
                            onClick={() =>
                              handleEditClick(item._id, item.description)
                            }
