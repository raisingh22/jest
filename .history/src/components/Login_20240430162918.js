...
const Login = () => {
  ...
  const handleUpdateJoke = async (jokeId, language) => {
    try {
      const response = await updateJoke(token, jokeId, language, editedJokeText);
                    ...
                    <div className="col-auto">
                      {editingJokeId === item._id ? (
                        <button
                          ...
                          onClick={() => handleUpdateJoke(item._id, item.lang)}
                        >
                          Update
                        </button>
                      ) : (
